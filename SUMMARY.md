...
- [Locator Strategies](selenium/basics/Locator_Strategy.md)  
   - [By ID](selenium/basics/By_ID.md)
   - [By Name](selenium/basics/By_Name.md)
   - [By CSS](selenium/basics/By_CSS.md)
...
- [Protractor Installation](protractor/installation.md)
- [Tests](protractor/tests-description.md)
	- [Tests without Page Object](protractor/test-without-astrolabe.md)
	- [Implementing Page Object with Protractor](protractor/using-page-object-with-protractor.md)
	- [Protrator API](protractor/api.md)
- [Running Configuration](protractor/configuration.md)